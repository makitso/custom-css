# webtrees 2 standard theme enhancements version 1.0.5
...
Style changes are for webtrees 2 only. Tested for release  **2.0.7 released in  July 2020**.  Currently, does not work for 2.0.8 beta.
